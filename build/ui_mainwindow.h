...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        progressBarMeter->setGeometry(QRect(445, 34, 130, 8));
        ...
        labelCAT->setGeometry(QRect(314, 74, 16, 10));
        ...
        labelPWR->setGeometry(QRect(314, 85, 16, 10));
        ...
        labelPTT->setGeometry(QRect(314, 96, 16, 10));
        ...
        labelVFO->setGeometry(QRect(370, 30, 31, 16));
        QFont font3;
        font3.setPointSize(8);
        font3.setBold(true);
        font3.setWeight(75);
        labelVFO->setFont(font3);
        labelSPLIT = new QLabel(widgetControls);
        labelSPLIT->setObjectName(QStringLiteral("labelSPLIT"));
        labelSPLIT->setGeometry(QRect(370, 40, 31, 16));
        labelSPLIT->setFont(font3);
        labelRIT = new QLabel(widgetControls);
        labelRIT->setObjectName(QStringLiteral("labelRIT"));
        labelRIT->setGeometry(QRect(370, 50, 31, 16));
        labelRIT->setFont(font3);
        labelLOCK = new QLabel(widgetControls);
        labelLOCK->setObjectName(QStringLiteral("labelLOCK"));
        labelLOCK->setGeometry(QRect(370, 60, 31, 16));
        labelLOCK->setFont(font3);
        labelBRK = new QLabel(widgetControls);
        labelBRK->setObjectName(QStringLiteral("labelBRK"));
        labelBRK->setGeometry(QRect(370, 70, 31, 16));
        labelBRK->setFont(font3);
        labelKEY = new QLabel(widgetControls);
        labelKEY->setObjectName(QStringLiteral("labelKEY"));
        labelKEY->setGeometry(QRect(370, 80, 31, 16));
        labelKEY->setFont(font3);
        labelMODE = new QLabel(widgetControls);
        labelMODE->setObjectName(QStringLiteral("labelMODE"));
        labelMODE->setGeometry(QRect(400, 80, 31, 16));
        labelMODE->setFont(font3);
        labelMETER = new QLabel(widgetControls);
        labelMETER->setObjectName(QStringLiteral("labelMETER"));
        labelMETER->setGeometry(QRect(411, 28, 31, 16));
        labelMETER->setFont(font3);
        label->raise();
        toggleAM->raise();
        label_2->raise();
        spinFreq->raise();
        ...
        pushButtonBandVF->raise();
        pushButtonBandLF->raise();
        pushButtonBand160->raise();
        pushButtonBand80->raise();
        pushButtonBand40->raise();
        pushButtonBand30->raise();
        pushButtonBand20->raise();
        pushButtonBand17->raise();
        pushButtonBand15->raise();
        pushButtonBand12->raise();
        pushButtonBand10->raise();
        pushButtonBand6->raise();
        pushButtonBandFM->raise();
        pushButtonBandAir->raise();
        pushButtonBand2->raise();
        pushButtonBand70->raise();
        pushButtonBand012->raise();
        pushButtonBandFree->raise();
        toggleDSP->raise();
        labelCAT->raise();
        labelPWR->raise();
        labelPTT->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelSPLIT->setText(QApplication::translate("MainWindow", "SPLIT", Q_NULLPTR));
        labelRIT->setText(QApplication::translate("MainWindow", "RIT", Q_NULLPTR));
        labelLOCK->setText(QApplication::translate("MainWindow", "LOCK", Q_NULLPTR));
        labelBRK->setText(QApplication::translate("MainWindow", "BRK", Q_NULLPTR));
        labelKEY->setText(QApplication::translate("MainWindow", "KEY", Q_NULLPTR));
